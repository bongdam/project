...
#endif
#ifdef __DAVO__
    struct net_bridge_port *dstprev;
#endif
...
#if 1
						fdb->dst->dev->netdev_ops->ndo_do_ioctl(fdb->dst->dev, (struct ifreq *)&wrq, 0x8b82);
#else
...
#ifdef __DAVO__
struct net_device *br_fdb_match(struct net_bridge *br, const unsigned char *addr, u16 vid)
{
