...
#define MIB_IPFILTER_NEW_IMPORT
#include "mibdef.h"
#undef MIB_IPFILTER_NEW_IMPORT
...
{MIB_ROOT, "MIB_ROOT",		TABLE_LIST_T, 	0, _UNIT_SIZE(APMIB_T), _UNIT_SIZE(APMIB_T), _UNIT_SIZE(APMIB_T), 0, mib_table,_REINIT_FIELD(0,0)},
{0}
};
#else
mib_table_entry_T mib_root_table[]={
...
_UNIT_SIZE(RF_DPK_SETTING_T), _UNIT_SIZE(RF_DPK_SETTING_T), 0, rf_dpk_mib_table,_REINIT_FIELD(0,0)},
#else
{_MIBID_NAME(RF_DPK_ROOT),		TABLE_LIST_T, 	0, _UNIT_SIZE(RF_DPK_SETTING_T)},
#endif
{0}
