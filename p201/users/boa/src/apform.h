...
#else
#define APPLY_COUNTDOWN_TIME 30
#endif
#else
...
extern int dv_wlaninfo(request *wp, int argc, char **argv);
extern int IPSecVPNList(request *wp, int argc, char **argv);
extern void formIpsecVpnEnable(request *wp, char *path, char *query);
extern void formIpsecVpnSetting(request *wp, char *path, char *query);
extern void formIpsecVpnDelete(request *wp, char *path, char *query);
extern void formL2tpVpnEnable(request *wp, char *path, char *query);
extern void formL2tpVpnSetting(request *wp, char *path, char *query);
extern void formLogin(request *wp, char *path, char *query);
extern void formFotaUpload(request *wp, char *path, char *query);
extern void formFotaConfig(request *wp, char *path, char *query);
extern void formNvramSave(request *wp, char *path, char *query);
extern void formNvramRestore(request *wp, char *path, char *query);
extern void formSaveConfigReset(request *wp, char *path, char *query);
extern void formPassthru(request *wp, char *path, char *query);
extern void formTcpipPort(request *wp, char *path, char *query);
extern void formRebootShd(request *wp, char *path, char *query);
extern void formIpv6PassThru(request *wp, char *path, char *query);
extern void formSetOperation(request *wp, char *path, char *query);
extern void formWps(request *wp, char *path, char *query);
extern void formWpsStatus(request *wp, char *path, char *query);
#endif
