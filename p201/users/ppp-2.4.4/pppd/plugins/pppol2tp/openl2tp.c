...
//davo const char pppd_version[] = VERSION;
...
void openl2tp_plugin_init(void)
//davo  void plugin_init(void)
{
...
//davo	old_multilink_join_hook = multilink_join_hook;
//davo	multilink_join_hook = openl2tp_multilink_join_ind;
}
