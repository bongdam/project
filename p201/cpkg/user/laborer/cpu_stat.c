...
char *strtime(const time_t *timep, char *buf, int len)
{
...
static int mod_cpu_stat(int argc, char **argv, int fd)
{
	int i, len = 0;
	unsigned long long g_itv;
