...
#define DF_WANBOUND     (1 << (PRTNR_END + 1))
#define DF_LANBOUND     (1 << (PRTNR_END + 2))
#define DF_IPADDRDUP    (1 << (PRTNR_END + 3))
#define DF_UPLOADING    (1 << (PRTNR_END + 4))
#define DF_NTPSYNC	(1 << (PRTNR_END + 5))
#define DF_INITED	(1 << (PRTNR_END + 6))
#define DF_REBOOTING	(1 << (PRTNR_END + 7))
#define DF_RSTASSERTED	(1 << (PRTNR_END + 8))
#define DF_WPSASSERTED	(1 << (PRTNR_END + 9))
#define DF_WANIPFILE	(1 << (PRTNR_END + 10))
#define DF_INETUP	(1 << (PRTNR_END + 11))
