...
/*
���s���ըýT�{��A�U�C��leaky bucket �ѼƤ��ݭץ��A�ҥH�O���쥻��default �ȧY�i�A��p�y���j�a���x�Z!
...
#ifdef __DAVO__
static long onesec_jiffy;
extern void sysled_blinker(long token);
#endif
static volatile long jiffies_t3=0;
...
//	mdc_timer_fn();
	...
	jiffies_t3++;
#ifdef __DAVO__
	if ((jiffies_t3 - onesec_jiffy) >= 100) {
		onesec_jiffy = jiffies_t3;
		ckeck_link_speed();
	}
	sysled_blinker(20);
#else
...
#endif
#ifdef __DAVO__
#undef GPIO_RESET_97FN
#define GPIO_RESET_97FN 9
#endif
...
#else
		// LED_P0
		REG32(PIN_MUX_SEL14) &= ~(0xf << 28);
		// GPIOF[1] 
		REG32(PIN_MUX_SEL18) = (REG32(PIN_MUX_SEL18) & ~(0xf << 28)) | (0x2 << 28);
#endif
