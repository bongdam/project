...
typedef struct _setting_header_ {
	...
	unsigned short len;
#ifdef __DAVO__
	unsigned int kern_offset, root_offset;
#endif
...
#ifdef __DAVO__
extern unsigned long return_addr;
#else
...
//flash mapping
#ifdef __DAVO__
#define ROOT_FS_OFFSET		(0x290000)
#else
...
#else
#define Set_GPIO_LED_ON()	do {} while (0)
#define Set_GPIO_LED_OFF()      do {} while (0)
#endif
void Init_GPIO();
#endif
