...
#define BSP_RESET_BTN_PIN_MUX			(0x1 << 16)
#define BSP_RESET_BTN_PIN_MASK			(0xf << 16)
#define BSP_SYS_LED_PIN				BSP_GPIO_PIN_E5
#define BSP_SYS_LED_PIN_MUX_SEL			BSP_PIN_MUX_SEL17
#define BSP_SYS_LED_PIN_MUX			(0x1 << 12)
#define BSP_SYS_LED_PIN_MASK			(0xf << 12)
# else
