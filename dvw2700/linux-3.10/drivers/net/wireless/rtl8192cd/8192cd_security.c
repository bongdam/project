...
#ifdef __DAVO__
					Disassociation_Ind.tx_only_data_packets = pstat_del->tx_only_data_packets;
					Disassociation_Ind.rx_only_data_packets = pstat_del->rx_only_data_packets;
					Disassociation_Ind.tx_only_data_bytes = pstat_del->tx_only_data_bytes;
					Disassociation_Ind.rx_only_data_bytes = pstat_del->rx_only_data_bytes;
#endif
