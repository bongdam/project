...
#ifdef GPIO_LED_2G
	sys_gpio_operate((flag == LED_OFF) ? __GPIOSINACT : __GPIOSACTIVE, __stringify(GPIO_LED_2G), NULL);
#else
#if 1
        if(flag) /* led off*/
...
#ifdef GPIO_LED_5G
	sys_gpio_operate((flag == LED_OFF) ? __GPIOSINACT : __GPIOSACTIVE, __stringify(GPIO_LED_5G), NULL);
#else
        if(flag) /* led off*/
...
#ifdef GPIO_LED_2G
	sys_gpio_operate(__GPIOCOUT, __stringify(GPIO_LED_2G), NULL);
	sys_gpio_operate(__GPIOSACTIVE, __stringify(GPIO_LED_2G), NULL);
#else
	  int err;
...
#ifdef GPIO_LED_5G
	sys_gpio_operate(__GPIOCOUT, __stringify(GPIO_LED_5G), NULL);
	sys_gpio_operate(__GPIOSACTIVE, __stringify(GPIO_LED_5G), NULL);
#else
