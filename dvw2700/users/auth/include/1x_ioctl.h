...
#define DOT11_ASSOCIATION_INFORMATION DOT11_ASSOCIATION_INFO
#define PDOT11_ASSOCIATION_INFORMATION PDOT11_ASSOCIATION_INFO
...
#if defined(__DAVO__)
		,
        acct_admin_drop			= 34,	// youngho DAVO
        acct_admin_reboot			= 35,	// youngho DAVO
        acct_admin_reboot_2nd		= 36	// youngho DAVO
#endif
}ReasonCode;


#define MacAddrLen      MACADDRLEN

#if 0
/* defined 8192cd_security.h */
/*
...
int lib1x_control_ClearSTA(Global_Params * global);
#endif
