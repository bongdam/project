...
#if defined(__DAVO__)
#define LIB1X_RAD_TERMINATE_ACTION	 29
#define LIB1X_RAD_ACCT_FRAMED_IP_ADDRESS 8	// youngho DAVO
#endif
...
struct radius_info	 /* one struct for radius related bookkeeping */
{
	...
	char	 nas_identifier[MAX_NAS_ID_LEN];		/* string identifying the Authenticator TODO .. this is so static now !	*/
	char   connectinfo[50];		/* = "CONNECT 11 Mbps 802.11b" */
...
#if defined(__DAVO__)
void lib1x_rad_term_action(Global_Params * global, u_char * rattr_ptr, int length);
#endif
