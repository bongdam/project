...
//				memset(&global->akm_sm->CurrentReplayCounter, '\0', sizeof(LARGE_INTEGER));
	...
	case DOT11_EVENT_DISASSOCIATION_IND:
			...
			memcpy(&global->theAuthenticator->acct_sm->tx_packets, (void *)((unsigned int)pDisAssoInd + (int)(&((DOT11_DISASSOCIATION_IND *)0)->tx_only_data_packets)), sizeof(unsigned long));       // == transmited packets
	 		...
	 		memcpy(&global->theAuthenticator->acct_sm->tx_bytes, (void *)((unsigned int)pDisAssoInd + (int)(&((DOT11_DISASSOCIATION_IND *)0)->tx_only_data_bytes)), sizeof(unsigned long));         // == transmited bytes
	 		memcpy(&global->theAuthenticator->acct_sm->rx_bytes, (void *)((unsigned int)pDisAssoInd + (int)(&((DOT11_DISASSOCIATION_IND *)0)->rx_only_data_bytes)), sizeof(unsigned long));         // == received bytes
	 		memcpy(&global->theAuthenticator->acct_sm->tx_bytes_h, (void *)((unsigned int)pDisAssoInd + (int)(&((DOT11_DISASSOCIATION_IND *)0)->tx_only_data_bytes_high)), sizeof(unsigned long));         // == transmited bytes	youngho DAVO
	 		memcpy(&global->theAuthenticator->acct_sm->rx_bytes_h, (void *)((unsigned int)pDisAssoInd + (int)(&((DOT11_DISASSOCIATION_IND *)0)->rx_only_data_bytes_high)), sizeof(unsigned long));         // == received bytes	youngho DAVO
#else
