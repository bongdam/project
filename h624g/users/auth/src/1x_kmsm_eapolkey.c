...
extern int omac1_aes_128(const unsigned char *key, const unsigned char *data, int data_len, unsigned char *mac);
...
#ifdef RTL_WPA2
void CalcPMKID(u_char* pmkid, u_char* pmk, u_char* aa, u_char* spa
