...
function get_data_size_converter(data_h, data_l) {
  ...
  for (i = 0; i < 4; i++) {
    if (upperQuotient != 0 || bottomQuotient >= 1024) {
      ...
      bottomQuotient = bottomQuotient >>> 0;
    } else
      break;
  }
...
function saveChanges_basic(form, wlan_id) {
  ...
  if ( wlan_id ) {
  	if ( chan_number == 0 ) {
  		form.elements["channelbound"+wlan_id].disabled = false;
		form.elements["channelbound_manual"+wlan_id].disabled = true;
	} else {
		form.elements["channelbound"+wlan_id].disabled = true;
		form.elements["channelbound_manual"+wlan_id].disabled = false;
	}
  } else {
  	form.elements["channelbound"+wlan_id].disabled = false;
  	form.elements["channelbound_manual"+wlan_id].disabled = true;
...
function updateChan_selectedIndex(form, wlan_id) {
  ...
  if ((parseInt(wlan_id) == 0) && (parseInt(chan_number) >= 52 && parseInt(chan_number) <= 120)) {
