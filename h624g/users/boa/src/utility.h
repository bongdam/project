...
#define CAPTCHA_INIT_STR	"unit number variable doesn't exist"
#define CAPTCHA_STR_POOL			"1234567890abcdefghijklmnopqrstuvwxyz"
#define CAPTCHA_STR_POOL_LEN		strlen(CAPTCHA_STR_POOL)   //(sizeof(CAPTCHA_STR)-1)
#define CAPTCHA_STR_LEN		6
...
/* helper functions to compose log */
...
/* APACRTL-85 */
char *web_log_wlname(char *, size_t);
