...
int setInAddr(char *interface, char *Ipaddr, char *Netmask, char *HwMac,
	      int type);
...
void Create_script(char *script_path, char *iface, int network, char *ipaddr,
		   char *mask, char *gateway);
