/* $Id: ares.h,v 1.1.1.1 2010-04-12 02:11:36 youngho Exp $ */
...
/*DAVO begin*/
time_t uptime(time_t *tm);

#define BULK_DNS_CACHE	0

struct dns_bulk_result {
    unsigned int ip;
    unsigned int port;
    char *host;
};

void dns_bulk_query(char **argv, int argc, struct dns_bulk_result **result, int *rescnt, int repeat_count);
