...
int send_renew(unsigned long xid, unsigned long server, unsigned long ciaddr, char *h_dest);
int send_release(unsigned long server, unsigned long ciaddr, char *h_dest);
