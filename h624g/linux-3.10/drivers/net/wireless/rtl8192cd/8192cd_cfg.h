...
//-------------------------------------------------------------
/* 
	Rewrite reg(808)'s value, 0xff -> 0x66 for receiving sensitivity by netami
...
//-------------------------------------------------------------
#ifdef CONFIG_PCI_HCI
#if !defined(__DAVO__) || !defined(DAVO_ENABLE_RATELIMIT)
#define GBWC
#endif
#endif
...
#define LED_ON_TIME				RTL_MILISECONDS_TO_JIFFIES(80)	// 80ms
#define LED_ON					0
#define LED_OFF					1
#define LED_0 					0
#define LED_1 					1
