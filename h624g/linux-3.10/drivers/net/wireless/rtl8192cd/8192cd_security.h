...
typedef enum{
	...
	DOT11_AuthKeyType_FT8021x = DOT11_AuthKeyType_NonRSN802dot1x,
	DOT11_AuthKeyType_FT = DOT11_AuthKeyType_NonRSN802dot1x,
	DOT11_AuthKeyType_FTPSK = 4,
#endif
	DOT11_AuthKeyType_802_1X_SHA256 = 5,		//CONFIG_IEEE80211W_CLI
	DOT11_AuthKeyType_PSK_SHA256 = 6,
#define DOT11_AuthKeyType_RSNPSK DOT11_AuthKeyType_PSK 
...
#if defined(RTL_WPA2_PREAUTH) || defined (RTL_WPA2)
...
#if defined(P2P_SUPPORT) || defined(WIFI_SIMPLE_CONFIG)
...
#endif	
/* copy from user/auth/include/1x_ioctl.h */
#ifdef AUTO_CONFIG
...
#endif
#if defined(__DAVO__)
	DOT11_EVENT_SET_PORT_WEBRD = 190,
	DOT11_EVENT_ACC_CLEAR_STATS = 191,
#endif
	DOT11_EVENT_UNKNOWN = 192
...
#define DOT11_ASSOCIATION_RSP DOT11_ASSOCIATIIN_RSP
...
typedef struct _DOT11_DISASSOCIATION_IND{
	...
	unsigned long	tx_bytes_h;         // == transmited bytes youngho DAVO
	unsigned long	rx_bytes_h;         // == received bytes youngho DAVO
...
typedef DOT11_DISASSOCIATION_IND DOT11_DEAUTHENTICATION_IND;
#else
...
#define DOT11_SETPORT DOT11_SET_PORT 
