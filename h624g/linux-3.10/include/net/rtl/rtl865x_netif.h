...
#    define RTL865X_ACLTBL_DROP_ALL		254
						//This rule is always "Drop"
...
#        define RTL_LANPORT_MASK		0x110
						//mark_inic , only port4 connect to MII
#      elif defined(CONFIG_RTK_INBAND_HOST_HACK)
#        if defined(CONFIG_8198_PORT5_GMII)
#          define RTL_WANPORT_MASK		0x120
						//port5 ,hack port,eth1
#          define RTL_LANPORT_MASK		0x11f
						// 0~4 port eth0
#        else
#          define RTL_WANPORT_MASK		0x110
						//port4(port0 in some board) is eth1
#          define RTL_LANPORT_MASK		0x12f
						// 0 1 2 3 5  port are eth0
#        endif
...
#    define RTL_WANPORT_MASK			0x1e0
						//port 5, port 6,port 7,port 8
#    define RTL_LANPORT_MASK			0x1df
							//port 0~4 , port 6~8  , need port4 ??
#  elif defined(CONFIG_8198_PORT5_GMII)
#    define RTL_WANPORT_MASK			0x110
...
#  elif defined(CONFIG_RTL_PUBLIC_SSID)
#    define RTL_WANPORT_MASK			0x110	//port 4/port 8
#  elif defined(CONFIG_RTL8186_KB_N) || defined(CONFIG_RTL_819X)	/* CONFIG_RTL8196_RTL8366 */
...
#        define RTL_WANPORT_MASK		0x10
#        define RTL_LANPORT_MASK		0x10f
#        define RTL_LANPORT_MASK_1		0x1
#        define RTL_LANPORT_MASK_2		0x2
#        define RTL_LANPORT_MASK_3		0x4
#        define RTL_LANPORT_MASK_4		0x8
#      endif
#    endif
#  else
#    define RTL_WANPORT_MASK			0x01
#    define RTL_LANPORT_MASK			0x11e
							/* port1/2/3/4/cpu port(port 8) */
...
int32 rtl865x_setDefACLForAllNetif(uint8 start_ingressAclIdx, uint8 end_ingressAclIdx, uint8 start_egressAclIdx,
				   uint8 end_egressAclIdx);
