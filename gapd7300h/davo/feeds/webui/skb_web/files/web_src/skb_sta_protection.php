...
var change_select = function(obj_){
	...
	if(obj.children(":selected").val() == ""){
		var tempVal = "<input type=\"text\" name=\""+objname+"\" id=\""+objid+"\" value=\""+obj.attr("preval")+"\" maxlength=\"17\">";
...
$(document).ready(function(){
	...
	if(sta.length > 0){
		var tempVal = "<select name=\"sta_mac\" id=\"sta_mac\" onchange=\"change_select(this)\" preval=\""+sta[0]+"\">\n";
		...
		var tempVal = "<input type=\"text\" name=\"sta_mac\" id=\"sta_mac\" value=\"\" maxlength=\"17\">";
...
<table border="0" width="500" cellspacing="4" cellpadding="0">
	<tr>
		<td><font size="2">무선접속 제한 서비스 설정을 할 수 있는 페이지입니다.</font></td>
	</tr>
	<tr>
...
<fieldset  style="border-right: #000000 1px solid; padding-right: 10px; border-top: #000000 1px solid; padding-left: 10px; padding-bottom: 5px; border-left: #000000 1px solid; width: 700px; padding-top: 0px; border-bottom: #000000 1px solid; "><legend><b>무선접속 제한 서비스</b></legend>
<div style="width:160px;float:right"><span id="time"><?=date('Y/m/d H:i:s');?></span>&nbsp;<i class="fa fa-refresh" aria-hidden="true" onclick="ntp_restart();" style="cursor:pointer;"></i></div>
<table border="0" style="width:100%;">
	<tr>
		<td class="tl">단말이름</td>
		<td><input type="text" name="sta_name" id="sta_name" value="" maxlength="20"></td>
		<td class="tl">허용/차단</td>
		<td><input type="radio" name="rule" id="rule1" value="1">허용<input type="radio" name="rule" id="rule0" value="0" checked>차단</td>
	</tr>
	<tr>
		<td class="tl">단말주소(MAC)</td>
		<td colspan="3"><span id="mac_area"></span></td>
	</tr>
	<tr>
		<td class="tl">요일</td>
		<td colspan="3"><input type="checkbox" name="week" id="week0" value="1">일<input type="checkbox" name="week" id="week1" value="1">월<input type="checkbox" name="week" id="week2" value="1">화<input type="checkbox" name="week" id="week3" value="1">수<input type="checkbox" name="week" id="week4" value="1">목<input type="checkbox" name="week" id="week5" value="1">금<input type="checkbox" name="week" id="week6" value="1">토</td>
	</tr>
	<tr>
		<td class="tl">시간</td>
...
<br>
<input type="button" value="추가" name="btn_apply" onclick="form_add();"> &nbsp;<input type="button" value="적용" name="btn_apply" id="btn_apply" onclick="form_apply();">
...
<table style="width:720px">
	...
	<tbody id="tbdy" style="background-color:#ddd;text-align:center;"></tbody>
</table>
<input type="button" value="삭제" name="btn_apply" onclick="form_del();">
...
<span>허용 : 설정된 시간만 인터넷 이용가능하며 나머지 시간은 인터넷 차단 됨<br>
차단 : 설정된 시간만 인터넷 이용 차단<br>
* 동일 단말에 대해서는 허용/차단 1개만 가능<br>
<span style="color:red;">* 무선접속차단시간에는 WiFi를 사용할수 없으며 스마트폰의 LTE/3G로 전환 시 데이터소진이 될수 있음에 유의</span>
</span>
</form>
