...
#ifdef ATH_TX99_DIAG
    struct ieee80211_channel *  (*ath_net80211_find_channel)(struct ath_softc *sc, int ieee, u_int8_t des_cfreq2, enum ieee80211_phymode mode);
#endif
...
#define ATH_ISR_NOTMINE         0x0002  /* This was not my interrupt - for shared IRQ's    */
  ...
  /**
    ...
    u_int32_t    (*ath_atf_debug_nodestate)(ath_node_t node);
#endif
    /* GreenAP stuff */
    /**
