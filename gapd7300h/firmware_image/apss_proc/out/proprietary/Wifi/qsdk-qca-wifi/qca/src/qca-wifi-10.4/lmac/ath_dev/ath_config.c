...
ath_get_config(ath_dev_t dev, ath_param_ID_t ID, void *buff)
{
    ...
    switch(ID)
    {
        ...
        case ATH_PARAM_ATH_RXQ_INFO:
        {
            ...
            QDF_PRINT_INFO(sc->sc_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "rxfifo =%p, rxfifodepth = %d, rxfifohwsize =%d, rxfifoheadindex=%d, rxfifotailindex=%d\n",
            ...
            QDF_PRINT_INFO(sc->sc_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "sc_rxbuf num of elements = %d, bf=%p, bf_mpdu=%p\n", i, bf, bf?bf->bf_mpdu:0 );
        }
        break;
