...
#define ATH_NODE_LEAVE           0x20    /* indicates the node leave */
    ...
    atomic_t    an_atf_nodepaused;      /* Set when a node is paused by ATF */
    ...
    u_int32_t   an_num_buf_held_sc;     /* Buffers held by a node from the common (sc) pool */
    ...
    u_int32_t   an_shadow_atf_txtoken;  /* Shadow of tokens available for a node */
    ...
    u_int32_t   an_tx_unusable_tokens_updated:1, /* for athstats */
                an_atf_nomore_tokens:1, /* is this node using all tokens */
...
#define NUM_TX_EP           12
    ...
    qdf_nbuf_queue_t        sc_rxwbufhead;
#ifdef ATH_HTC_SG_SUPPORT
