...
--Monitoring settings
------------------------------------------------------------------------------------------------
s = m:section(TypedSection, "Monitor", translate("Monitoring settings for legacy clients"))
s.anonymous = true

vl = s:option(Value, "DisableMonitoringLegacyClients", translate("DisableMonitoringLegacyClients"))
vl.datatype = "uinteger"
